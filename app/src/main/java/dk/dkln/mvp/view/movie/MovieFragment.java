...
public class MovieFragment extends BaseFragment implements ViewPager.OnPageChangeListener{
    ...
    private MovieLiveFragment movieLiveFragment;
    private MovieTopFragment movieTopFragment;
